        ...
        <div class="footerGrid">
            <div class="footerCustomerService">
                <ul class="footerUL">
                    ...
                    <li class="footerContact"><i class="fa-solid fa-phone"></i>
                    <p tabindex="0">+45 6767-6767</p></li>
                    <li class="footerContact"><i class="fa-solid fa-envelope"></i>
                    <p tabindex="0">Kanten@Kanten.dk</p></li>
