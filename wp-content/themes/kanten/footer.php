    ...
    <div class="footerContainer">
        <div class="footerGrid">
            <div class="footerCustomerService">
                <ul class="footerUL">
                    <li class="footerTitle"><h3 tabindex="0"><?php pll_e("Kundeservice")?></h3><div class="footerLine"></div></li>
            ...
            <div class="footerAbout">
                <ul class="footerUL">
                    <li class="footerTitle"><h3 tabindex="0">Kanten</h3><div class="footerLine"></div></li>
            ...
            <div class="footerService">
                <ul class="footerUL">
                    <li class="footerTitle"><h3 tabindex="0">Service</h3><div class="footerLine"></div></li>
